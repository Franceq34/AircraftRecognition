...
Shader "WeatherMaker/WeatherMakerSkySphereShader"
{
	Properties
	{
		...
		_WeatherMakerSkyAbsRayY("1 = Take abs of ray y, 0 = Default", Int) = 0
	}
	SubShader
	{
		...
		fixed4 fragBase(v2fSky i)
		{
			...
			{
				procedural_sky_info sky = CalculateScatteringCoefficients(_WeatherMakerSunDirectionUp, _WeatherMakerSunColor.rgb, 1.0, i.ray);
				procedural_sky_info sky2 = CalculateScatteringColor(_WeatherMakerSunDirectionUp, _WeatherMakerSunColor.rgb, _WeatherMakerSunVar1.x, i.ray, sky.inScatter, sky.outScatter);
				skyColor = sky2.skyColor;
