    ...
    public class WeatherMakerFullScreenCloudsScript : MonoBehaviour
    {
        ...
        private void GenerateWeatherMap(Camera camera)
        {
            ...
            if (WeatherMapRenderTexture != null)
            {
                ...
                weatherMapCommandBuffer.Blit(BuiltinRenderTextureType.CameraTarget, WMS._MainTex2, Material, 4);
                weatherMapCommandBuffer.Blit(null, CloudShadowRenderTexture, Material, 5);
                weatherMapCommandBuffer.ReleaseTemporaryRT(WMS._MainTex2);
                //weatherMapCommandBuffer.Blit(BuiltinRenderTextureType.CameraTarget, CloudShadowRenderTexture, Material, 4);
                weatherMapCommandBuffer.SetGlobalTexture(WMS._WeatherMakerCloudShadowTexture, CloudShadowRenderTexture);
                ...
                {
                    camera.AddCommandBuffer(CameraEvent.BeforeForwardOpaque, weatherMapCommandBuffer);
                }
            }
        }
